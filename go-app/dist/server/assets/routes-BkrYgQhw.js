import { C as remainingLabel, D as weekDays, E as timedEvents, O as cn, S as relativeLabel, T as ribbonHours, _ as formatRange, b as nextUp, d as dateKey, f as eventMetrics, g as formatDayTitle, h as formatClock, i as KIND_LABEL, l as useSchedule, m as fingerprintEvents, n as KindDot, o as sculptSchedule, p as eventsOnDay, r as Button, s as writeBrief, t as AppShell, u as allDayEvents, v as formatWeekday, x as parseKey, y as minutesFromStart } from "./app-shell-dK8bFt1Z.js";
import { t as useNow } from "./use-now-CAndyocM.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { isSameDay, parseISO } from "date-fns";
//#region src/lib/schedule/layout.ts
...
//#endregion
//#region src/components/ribbon.tsx
function Ribbon({ events, startHour, endHour, now, showNow, onSelect }) {
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			style: { height },
			children: [
				hours.map((hour, index) => /* @__PURE__ */ jsx("div", {
				...
				laid.map((event) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: "absolute top-2 bottom-2 left-1.5 w-px bg-accent/80" }), /* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: [
										/* @__PURE__ */ jsx(KindDot, { kind: event.kind }),
										/* @__PURE__ */ jsx("span", {
				...
				nowVisible ? /* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("span", { className: "now-dot relative z-10 ml-[38px] size-2 rounded-full bg-accent" }),
							/* @__PURE__ */ jsx("span", { className: "h-px flex-1 bg-accent" }),
							/* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/today-view.tsx
function TodayView() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: week.map((item) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("span", { className: cn("mt-1 size-1 rounded-full", has ? active ? "bg-sheet" : "bg-accent" : "bg-transparent", isToday && !has ? active ? "bg-sheet/70" : "bg-faint" : "") })
						]
					}, key);
				})
			}),
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: upcoming ? /* @__PURE__ */ jsxs("button", {
					type: "button",
				...
				}) : dayEvents.length === 0 ? /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					briefStale ? /* @__PURE__ */ jsx("span", {
						className: "text-xs text-muted",
						children: "日程已改"
					}) : null
				]
			}),
			brief ? /* @__PURE__ */ jsxs("article", {
			...
			sculpt ? /* @__PURE__ */ jsxs("article", {
				...
				children: [
					...
					sculpt.moves.length > 0 ? /* @__PURE__ */ jsx("ul", {
						className: "mt-3 space-y-2",
						children: sculpt.moves.map((move) => /* @__PURE__ */ jsxs("li", {
							className: "text-sm",
							children: [
								/* @__PURE__ */ jsx("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [sculpt.moves.length > 0 ? /* @__PURE__ */ jsx(Button, {
							size: "sm",
							onClick: applySculpt,
							children: "按此调整"
			...
			allDay.length > 0 ? /* @__PURE__ */ jsx("div", {
				className: "mt-5 flex flex-wrap gap-2",
				children: allDay.map((event) => /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => selectEvent(event.id),
					className: "inline-flex items-center gap-2 rounded-full bg-paper px-3 py-2 text-sm shadow-card",
					children: [/* @__PURE__ */ jsx(KindDot, { kind: event.kind }), event.title]
				}, event.id))
			}) : null,
			/* @__PURE__ */ jsxs("section", {
				className: "mt-6",
...
function Home() {
	return /* @__PURE__ */ jsx(AppShell, {
		active: "today",
		children: /* @__PURE__ */ jsx(TodayView, {})
	});
}
//#endregion
