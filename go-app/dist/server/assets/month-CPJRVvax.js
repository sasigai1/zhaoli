import { O as cn, _ as formatRange, d as dateKey, l as useSchedule, n as KindDot, p as eventsOnDay, t as AppShell, x as parseKey } from "./app-shell-dK8bFt1Z.js";
...
//#region src/components/month-view.tsx
function MonthView() {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: grid.map((day) => {
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						}), /* @__PURE__ */ jsx("span", { className: cn("size-1 rounded-full", has ? "bg-accent" : "bg-transparent") })]
					}, key);
				})
			}),
			/* @__PURE__ */ jsxs("section", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: selectedEvents.length === 0 ? /* @__PURE__ */ jsx("li", {
						className: "py-6 text-sm text-muted",
						children: "这一天还是空白。"
					}) : selectedEvents.map((event) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs("button", {
						type: "button",
