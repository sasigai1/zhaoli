import { C as localIsoDate, D as sectionState, E as parseDate, O as unfiledGaps, S as isFutureDate, T as padCount, a as useLedger, b as formatWeekdayEn, c as SECTIONS, d as completeness, f as dayOfYearLabel, g as formatChineseDate, h as filledItems, l as TAGS, m as fileId, o as DENSITIES, s as MOODS, v as formatDisplayDate, x as glyphCount, y as formatStampTime } from "./router-C8liBYT1.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { t as Button } from "./button-lc9gu-sZ.js";
import { n as Input, r as Textarea, t as FieldBox } from "./field-DEx_PKEc.js";
...
//#endregion
//#region src/components/day-editor.tsx
...
function DayEditor({ date }) {
	...
	const gaps = useMemo(() => date === today ? unfiledGaps(records, monthStart, today).filter((d) => d !== today) : [], [
		records,
		date,
		today,
		monthStart
	...
	if (invalid) return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					nextDisabled ? /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				"aria-hidden": true,
				children: SECTIONS.map((s) => /* @__PURE__ */ jsx("div", {
					className: cn("h-1 flex-1", state[s.key] ? "bg-ink" : "bg-rule"),
					title: `${s.no} ${s.label}`
				}, s.key))
			}),
			gaps.length > 0 ? /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [gaps.slice(0, 6).map((g) => /* @__PURE__ */ jsx(Link, {
						to: "/d/$date",
						params: { date: g },
						className: "font-mono text-xs tabular-nums text-stamp",
						children: formatDisplayDate(g)
					}, g)), gaps.length > 6 ? /* @__PURE__ */ jsxs(Link, {
						to: "/archive",
			...
			future ? /* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("section", { children: [
						...
						rec.summary && glyphSummary < 8 ? /* @__PURE__ */ jsxs("p", {
					...
					/* @__PURE__ */ jsxs("section", { children: [
						...
						/* @__PURE__ */ jsx("ul", {
							...
							children: rec.items.map((item, i) => /* @__PURE__ */ jsxs("li", {
								className: "flex items-center gap-2",
								children: [
									/* @__PURE__ */ jsx("span", {
									...
									}) : /* @__PURE__ */ jsx("span", { className: "size-11" })
								]
							}, i))
						}),
						!locked && rec.items.length < 5 ? /* @__PURE__ */ jsxs("button", {
							type: "button",
							onClick: addItem,
							className: "mt-2 flex h-11 items-center gap-2 pl-8 text-sm text-muted",
							children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), "添加事项"]
						}) : null
					] }),
					/* @__PURE__ */ jsxs("section", { children: [
						/* @__PURE__ */ jsx(SectionHead, {
						...
						rec.body && glyphBody < 40 ? /* @__PURE__ */ jsxs("p", {
							className: "mt-1.5 font-mono text-[10px] text-stamp",
							children: [
								"尚欠 ",
								40 - glyphBody,
					...
					/* @__PURE__ */ jsxs("section", { children: [/* @__PURE__ */ jsx(SectionHead, {
						no: "04",
						label: "评估",
						en: "ASSESSMENT",
						...
						children: [/* @__PURE__ */ jsx(ScaleRow, {
							name: "状态 MOOD",
							value: rec.mood,
							options: MOODS,
							disabled: locked,
						...
						children: locked ? /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("p", {
									...
									children: [/* @__PURE__ */ jsx(Lock, { className: "size-3.5" }), "本卷已锁定"]
								}),
								/* @__PURE__ */ jsx("p", {
							...
							hasContent(rec) ? /* @__PURE__ */ jsx("button", {
								type: "button",
