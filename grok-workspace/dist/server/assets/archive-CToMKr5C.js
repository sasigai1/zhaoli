import { C as localIsoDate, T as padCount, a as useLedger, d as completeness, h as filledItems, k as weekStarts, m as fileId, u as cellKind, v as formatDisplayDate, w as monthCells, x as glyphCount } from "./router-C8liBYT1.js";
import { t as cn } from "./utils-C_uf36nf.js";
import { n as Input, t as FieldBox } from "./field-DEx_PKEc.js";
import { useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ChevronLeft, ChevronRight, Search } from "lucide-react";
import { addMonths, format, parseISO } from "date-fns";
//#region src/components/archive-view.tsx
var KIND_LABEL = {
	empty: "未填",
	draft: "草稿",
	filed: "已归档",
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [weekStarts().map((d) => /* @__PURE__ */ jsx("div", {
					className: "pb-1 text-center font-mono text-[10px] tracking-widest text-faint",
					children: d
				}, d)), cells.map((id, i) => {
					if (!id) return /* @__PURE__ */ jsx("div", { className: "aspect-square" }, `e-${i}`);
					...
					if (kind === "future") return /* @__PURE__ */ jsx("span", {
						className,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("span", {
						...
						children: [/* @__PURE__ */ jsx("i", { className: "inline-block size-2 bg-ink" }), " 已归档"]
					}),
					/* @__PURE__ */ jsxs("span", {
						className: "flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx("i", { className: "inline-block size-2 bg-stamp-soft" }), " 草稿"]
					}),
					/* @__PURE__ */ jsxs("span", {
						className: "flex items-center gap-1.5",
						children: [/* @__PURE__ */ jsx("i", { className: "inline-block size-2 shadow-border" }), " 未填"]
					})
				]
			}),
			...
			/* @__PURE__ */ jsx("ul", {
				...
				children: list.length === 0 ? /* @__PURE__ */ jsxs("li", {
...
//#endregion
//#region src/routes/_folio/archive.tsx?tsr-split=component
function ArchivePage() {
	return /* @__PURE__ */ jsx(ArchiveView, {});
}
//#endregion
