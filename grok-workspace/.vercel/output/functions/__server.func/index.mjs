...
var grokOgIdentity = { "site": {
	...
	"card": "custom",
	"color": "F1EEE6",
	"description": "一日一档. A paper case-file for the day.",
	"image": "/og.jpg"
} };
//#endregion
...
function renderWebManifest(hostHeader) {
	...
	const hex = placeholderCardColor(readOgSite());
	const color = hex ? `#${hex}` : "#000000";
	...
	if (existsSync(join(cwd, "public/icon-192.png"))) icons.push({
		src: "/icon-192.png",
		sizes: "192x192",
		type: "image/png",
		purpose: "any"
	});
	if (existsSync(join(cwd, "public/icon-512.png"))) icons.push({
		src: "/icon-512.png",
		sizes: "512x512",
		type: "image/png",
		purpose: "maskable"
...
var _lazy_7caJPH = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_7caJPH
	};
	return ((_m, p) => {
		return {
			data,
