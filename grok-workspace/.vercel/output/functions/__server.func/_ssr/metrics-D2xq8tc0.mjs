...
import { d as eachDayOfInterval, l as startOfYear, n as parseISO, p as startOfWeek, r as subDays, u as startOfMonth } from "../_libs/date-fns.mjs";
import { C as localIsoDate, O as unfiledGaps, T as padCount, a as useLedger, d as completeness, h as filledItems, i as parseImportedLedger, l as TAGS, m as fileId, p as enumerateDays, r as exportPayload, s as MOODS, v as formatDisplayDate, x as glyphCount } from "./router-CaGjStSs.mjs";
import { t as cn } from "./utils-C_uf36nf.mjs";
import { t as Button } from "./button-lc9gu-sZ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/metrics-D2xq8tc0.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, {
					...
					title: "十六周热力",
					en: "HEAT"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeatStrip, {
					days: stats.heatDays,
					records,
					today
				})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				}), stats.gaps.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm text-muted",
					children: "本月截至今日，无未归档日。"
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
					className: "mt-3 border-t border-rule",
					children: stats.gaps.map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Header, {
					...
					className: "mt-3 flex flex-col gap-2",
					children: stats.tagDist.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BarRow, {
						label: t.tag,
						n: t.n,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: days.map((id) => {
				...
				if (id > today) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: cls,
...
function MetricsPage() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MetricsView, {});
}
//#endregion
