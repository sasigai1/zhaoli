...
import { n as KIND_LABEL, t as EDGE_LABEL } from "./types-BWtpnAqn.mjs";
import { n as List, r as ArrowUp, t as Plus } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { n as persist, r as create, t as createJSONStorage } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-clMm4bor.js
...
function FrameworkTree({ session, selectedId, justAddedIds, onSelect }) {
	...
	if (roots.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: roots.map((root) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Branch, {
			tree: root,
			depth: 0,
			session,
			selectedId,
...
function Branch({ tree, depth, session, selectedId, related, justAddedIds, extraByNode, byId, onSelect }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("relative", depth > 0 && "ml-5 border-l border-border pl-4 sm:ml-7 sm:pl-5"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(NodeRow, {
			...
			byId,
			onSelect
		}), tree.children.map((child) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Branch, {
			tree: child,
			depth: depth + 1,
			session,
			selectedId,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
		...
		children: [
			...
			selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				}), sources.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function SessionDrawer({ open, sessions, activeId, onClose, onOpen, onNew, onDelete }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("fixed inset-0 z-40 transition-opacity duration-300 ease-out", open ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			className: cn("absolute inset-y-0 left-0 flex w-full max-w-sm flex-col bg-surface shadow-hairline transition-transform duration-300 ease-out", open ? "translate-x-0" : "-translate-x-3"),
			"aria-hidden": !open,
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function SpineStrip({ nodes, selectedId, organizing, onJump }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: organizing ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "shimmer text-xs tracking-label",
				children: "整理"
			}) : nodes.map((node, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
...
function classifyClause(text) {
	const t = text.trim();
	if (/[?？]/.test(t) || /^(是不是|为什么|为何|如何|怎么|难道|该不该|要不要|是否|究竟)/.test(t)) return "question";
	if (/^(但是|可是|然而|不过|偏偏|只是|话虽如此|反过来说|问题是)/.test(t) || /^(but|however|yet)\b/i.test(t)) return "objection";
	if (/^(所以|因此|于是|可见|总之|综上|换句话说|真正的问题)/.test(t) || /^(so|therefore|thus|hence)\b/i.test(t)) return "synthesis";
	if (/^(因为|由于|毕竟|原因是|证据是|具体来说)/.test(t) || /^(because|since|as)\b/i.test(t)) return "evidence";
...
function makeTitle(session) {
	...
	const compact = (session.nodes.find((n) => n.kind === "question")?.text ?? session.nodes[0]?.text ?? session.entries[0]?.text ?? "未命名").replace(/\s+/g, " ").replace(/[。！？!?]$/, "");
	return compact.length > 18 ? `${compact.slice(0, 18)}…` : compact || "未命名";
}
...
function AppHome() {
	const hydrated = useLilu((s) => s.hydrated);
	...
	(0, import_react.useEffect)(() => {
		const done = () => useLilu.getState().setHydrated(true);
		const result = useLilu.persist.rehydrate();
	...
	const orderedNodes = (0, import_react.useMemo)(() => {
		if (!session) return [];
	...
	if (!hydrated || !session) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: editingTitle ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							autoFocus: true,
							value: titleDraft,
							"aria-label": "讨论标题",
							...
							type: "button",
							className: "max-w-full truncate font-serif text-base text-fg",
							onClick: () => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SpineStrip, {
				nodes: orderedNodes,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					session.spine && session.nodes.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mx-auto max-w-xl px-4 pt-6 pb-2 text-sm leading-relaxed text-pretty text-muted",
						children: session.spine
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FrameworkTree, {
						session,
						selectedId: selectedNodeId,
						justAddedIds,
						onSelect: (id) => useLilu.getState().setSelected(id)
					}),
					session.entries.length >= 2 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							children: "重新整理"
						}), organizeError && organizeError !== "unavailable" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SessionDrawer, {
				open: listOpen,
				sessions,
				activeId,
