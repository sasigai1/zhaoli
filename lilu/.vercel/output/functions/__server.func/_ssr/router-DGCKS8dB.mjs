...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DGCKS8dB.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "发生了未预期的错误。"
			})
		]
	});
}
...
var styles_default = "/assets/styles-DcpetG38.css";
var APP_NAME = "理路";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "记录自我讨论，把混乱的推演整理成可回看的脉络。"
			},
			{
				name: "theme-color",
				content: "#12110F"
...
var $$splitComponentImporter = () => import("./routes-clMm4bor.mjs");
