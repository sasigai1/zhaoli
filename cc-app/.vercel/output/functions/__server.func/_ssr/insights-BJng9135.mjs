...
import { i as TYPE_META, n as EVENT_TYPES } from "./types-DkEh41EK.mjs";
import { g as startOfWeek, l as format, t as zhCN, v as addDays } from "../_libs/date-fns.mjs";
import { f as cn, n as useMounted, r as useNow, s as useScheduleStore } from "./router-pw5uqWPz.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/insights-BJng9135.js
...
function InsightsPage() {
	...
	const stats = (0, import_react.useMemo)(() => computeStats(events, now), [events, now]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageShell, {
		...
		children: [
			...
			stats.overdue > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "类型"
				}), stats.typeRows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: Array.from({ length: 12 }, (_, w) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex flex-col gap-1",
							children: stats.heat.slice(w * 7, w * 7 + 7).map((cell) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
