import { a as colorForType } from "./types-DkEh41EK.js";
import { c as formatTimeLabel, d as todayISO, l as friendlyDay, n as useMounted, r as useNow, s as useScheduleStore } from "./router-Dzn3OfJZ.js";
import { a as Button, i as Textarea, n as Label } from "./field-DTONP9Vl.js";
import { n as ColorSwatches, r as TypePills, t as EventEditor } from "./event-editor-DZg5maeI.js";
import { t as PageShell } from "./page-shell-LKIFRGur.js";
import { n as parseScheduleAi } from "./ai-D9NYhU2B.js";
...
//#region src/lib/schedule/parse-local.ts
var WEEKDAY_MAP = {
	日: 0,
	天: 0,
	一: 1,
...
//#endregion
//#region src/routes/compose.tsx?tsr-split=component
var EXAMPLES = [
...
function ComposePage() {
	...
	return /* @__PURE__ */ jsxs(PageShell, {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: EXAMPLES.slice(1).map((ex) => /* @__PURE__ */ jsx("button", {
							type: "button",
							onClick: () => setText(ex),
			...
			drafts.length > 0 ? /* @__PURE__ */ jsxs("div", {
				className: "mt-4 flex flex-col gap-3",
				children: [drafts.map((d, i) => /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { children: friendlyDay(d.date, now) }),
								/* @__PURE__ */ jsx("span", { children: "·" }),
								/* @__PURE__ */ jsx("span", { children: formatTimeLabel(d.startTime, d.allDay) })
							]
						}),
						/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsx("div", {
							className: "mt-3",
							children: /* @__PURE__ */ jsx(TypePills, {
								value: d.type,
						...
						/* @__PURE__ */ jsx("div", {
							className: "mt-3",
							children: /* @__PURE__ */ jsx(ColorSwatches, {
								value: d.color,
								onChange: (hex) => patch(i, { color: hex })
							})
						})
					]
				}, `${d.title}-${i}`)), /* @__PURE__ */ jsxs(Button, {
					onClick: commit,
					size: "lg",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				}), manual ? /* @__PURE__ */ jsx("div", {
					className: "mt-4 rounded-xl bg-paper p-4 shadow-card",
					children: /* @__PURE__ */ jsx(EventEditor, {
						initial: {
							title: "",
							notes: "",
