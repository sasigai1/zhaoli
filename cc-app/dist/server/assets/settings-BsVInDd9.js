import { a as colorForType, n as EVENT_TYPES } from "./types-DkEh41EK.js";
import { a as unlockAudio, i as playChime, n as useMounted, p as uid, s as useScheduleStore } from "./router-Dzn3OfJZ.js";
import { a as Button, n as Label, r as NativeSelect } from "./field-DTONP9Vl.js";
import { t as PageShell } from "./page-shell-LKIFRGur.js";
import { useRef, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { toast } from "sonner";
import { format } from "date-fns";
//#region src/lib/schedule/ics.ts
function fold(line) {
	const chunks = [];
	let rest = line;
...
function Toggle({ checked, onChange, label, hint }) {
	return /* @__PURE__ */ jsxs("button", {
		...
		children: [/* @__PURE__ */ jsxs("span", { children: [/* @__PURE__ */ jsx("span", {
			...
			children: /* @__PURE__ */ jsx("span", { className: `absolute top-0.5 size-5 rounded-full bg-paper transition-transform duration-150 ${checked ? "translate-x-4" : "translate-x-0.5"}` })
		})]
	});
}
